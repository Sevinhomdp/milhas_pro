...
index 792dcaf23b58d8ec7d0a16b58fd663856223c446..a1d065f73bc0dc84cf5a14e9ac709e19c73d276d 100644
...
@@ -110,54 +123,61 @@ export default function Cartoes({ db, toast }: CartoesProps) {
                         </div>
                         <div className="mt-6">
