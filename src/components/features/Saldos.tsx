    ...
    return (
        ...
        >
            ...
            <div className="max-h-52 overflow-y-auto p-1.5">
                {filtered.length === 0 ? (
                    <p className="text-sm font-semibold text-slate-500 dark:text-slate-300 text-center py-4">
                    ...
                    filtered.map(prog => (
                        <button
                            ...
                            className={cn(
                                'w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-base font-extrabold text-left transition-all',
                                value === prog
                                    ? 'bg-amber-500 text-slate-900'
                                    : 'text-slate-800 dark:text-slate-100 hover:bg-slate-100 dark:hover:bg-white/10'
                            )}
                        >
                            <span className="w-8 h-8 rounded-lg bg-slate-200 dark:bg-slate-600 flex items-center justify-center text-sm font-black shrink-0">
                                {prog[0]}
                            </span>
                            {prog}
